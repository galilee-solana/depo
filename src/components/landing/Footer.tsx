...
export default function Footer() {
  ...
  return (
    <div className="pb-6">
    <footer className="container py-4 px-6 blue-gradient-bg rounded-3xl mx-8 sm:mx-16 md:mx-56 text-white">
        <div className="flex flex-col md:flex-row justify-between items-center">
          {/* Logo and copyright */}
          <div className="mb-4 md:mb-0">
            <div className="font-medium">DEPO - Dynamic Escrow Platform Operations</div>
          ...
          <div className="flex gap-4">
            <a href={process.env.NEXT_PUBLIC_GITHUB_URL || '#'} aria-label="GitHub" className="text-white">
