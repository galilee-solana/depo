...
function FeedbackSection() {
  return (
    <div id="feedback" className='h-fit mx-8 sm:pt-3 pb-3 sm:pb-12 sm:mx-16 xl:mx-56 text-black font-space'>
      <h2 className="text-[30px] sm:text-[40px] md:text-[46px] my-6">Tell Us Your Needs</h2>
